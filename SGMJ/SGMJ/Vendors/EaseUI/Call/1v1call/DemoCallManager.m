    ...
    @synchronized (_callLock) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            if (self.currentController) {
                ...
                [topRootViewController presentViewController:self.currentController animated:NO completion:nil];
...
- (void)makeCall:(NSNotification*)notify
{
    ...
    if (type == EMCallTypeVideo) {
        ...
        SHLog(@"弹出警告框")
//        [topRootViewController.navigationController presentViewController:alertController animated:YES completion:nil];
            ...
            @synchronized (self.callLock) {
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    if (strongSelf.currentController) {
                        ...
                        [topRootViewController presentViewController:strongSelf.currentController animated:NO completion:nil];
