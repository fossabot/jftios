...
@implementation SH_CitySelected
...
- (void)initBaseData{
    NSString *path = [[NSBundle mainBundle] pathForResource:@"Locationcity" ofType:@".plist"];
    SHLog(@"%@", path)
